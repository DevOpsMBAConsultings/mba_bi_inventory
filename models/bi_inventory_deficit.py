...
class MbaBiInventoryDeficit(models.Model):
    _name = "mba.bi.inventory.deficit"
    _description = "BI - Análisis de Déficit por Ventas Negativas"
    _auto = False
    _order = "deficit_value desc"
    ...
    negative_qty = fields.Float(string="Cantidad Negativa", readonly=True)
    cost = fields.Float(string="Costo Unitario", readonly=True)
    deficit_value = fields.Float(string="Déficit Total ($)", readonly=True)
